...
set "TARGET_DIR=%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup\MyApp"
...
(
  ...
  echo WshShell.Run chr(34^) & "%USERPROFILE%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\MyApp\start.bat" & Chr(34^), 0
